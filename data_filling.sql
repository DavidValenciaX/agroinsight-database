...
INSERT INTO insumo_agricola (categoria_id, nombre, descripcion, unidad_medida_id, costo_unitario, stock_actual, moneda_id) VALUES
-- Fertilizantes
((SELECT id FROM categoria_insumo_agricola WHERE nombre = 'Fertilizantes'),
 ...
 180000,
 125,
 (SELECT id FROM unidad_medida WHERE abreviatura = 'COP')),
...
INSERT INTO maquinaria_agricola (tipo_maquinaria_id, nombre, descripcion, modelo, numero_serie, costo_hora, moneda_id) VALUES
-- Tractores
...
INSERT INTO unidad_medida (nombre, abreviatura, categoria_id) VALUES
('Dírham de EAU', 'AED', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Afgani', 'AFN', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Lek', 'ALL', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dram', 'AMD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Florín Antillano', 'ANG', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Kwanza', 'AOA', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Peso Argentino', 'ARS', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar Australiano', 'AUD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Florín Arubeño', 'AWG', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Manat Azerbaiyano', 'AZN', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Marco Bosnioherzegovino', 'BAM', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar de Barbados', 'BBD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Taka', 'BDT', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Lev Búlgaro', 'BGN', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dinar Bareiní', 'BHD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Franco Burundés', 'BIF', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar Bermudeño', 'BMD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar de Brunéi', 'BND', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Boliviano', 'BOB', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Real Brasileño', 'BRL', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar Bahameño', 'BSD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Ngultrum', 'BTN', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Pula', 'BWP', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Rublo Bielorruso', 'BYN', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar Beliceño', 'BZD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar Canadiense', 'CAD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Franco Congoleño', 'CDF', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Franco Suizo', 'CHF', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Peso Chileno', 'CLP', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Yuan Chino', 'CNY', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Colón Costarricense', 'CRC', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Peso Cubano', 'CUP', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Escudo Caboverdiano', 'CVE', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Corona Checa', 'CZK', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Franco Yibutiano', 'DJF', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Corona Danesa', 'DKK', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Peso Dominicano', 'DOP', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dinar Argelino', 'DZD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Libra Egipcia', 'EGP', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Nakfa', 'ERN', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Birr Etíope', 'ETB', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar Fiyiano', 'FJD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Libra Malvinense', 'FKP', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Corona Feroesa', 'FOK', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Lari', 'GEL', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Libra de Guernsey', 'GGP', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Cedi', 'GHS', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Libra Gibraltareña', 'GIP', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dalasi', 'GMD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Franco Guineano', 'GNF', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Quetzal', 'GTQ', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar Guyanés', 'GYD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar de Hong Kong', 'HKD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Lempira', 'HNL', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Kuna Croata', 'HRK', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Gourde', 'HTG', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Forinto', 'HUF', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Rupia Indonesia', 'IDR', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Nuevo Séquel', 'ILS', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Libra de la Isla de Man', 'IMP', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Rupia India', 'INR', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dinar Iraquí', 'IQD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Rial Iraní', 'IRR', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Corona Islandesa', 'ISK', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Libra de Jersey', 'JEP', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar Jamaiquino', 'JMD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dinar Jordano', 'JOD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Yen', 'JPY', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Chelín Keniano', 'KES', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Som', 'KGS', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Riel', 'KHR', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar de Kiribati', 'KID', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Franco Comorense', 'KMF', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Won', 'KRW', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dinar Kuwaití', 'KWD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar de las Islas Caimán', 'KYD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Tenge', 'KZT', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Kip', 'LAK', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Libra Libanesa', 'LBP', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Rupia de Sri Lanka', 'LKR', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar Liberiano', 'LRD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Loti', 'LSL', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dinar Libio', 'LYD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dírham Marroquí', 'MAD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Leu Moldavo', 'MDL', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Ariary', 'MGA', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Denar', 'MKD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Kyat', 'MMK', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Tugrik', 'MNT', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Pataca', 'MOP', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Uguiya', 'MRU', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Rupia Mauriciana', 'MUR', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Rufiyaa', 'MVR', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Kwacha', 'MWK', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Ringgit', 'MYR', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Metical', 'MZN', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar Namibio', 'NAD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Naira', 'NGN', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Córdoba', 'NIO', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Corona Noruega', 'NOK', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Rupia Nepalí', 'NPR', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar Neozelandés', 'NZD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Rial Omaní', 'OMR', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Balboa', 'PAB', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Sol', 'PEN', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Kina', 'PGK', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Peso Filipino', 'PHP', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Rupia Pakistaní', 'PKR', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Złoty', 'PLN', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Guaraní', 'PYG', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Rial Qatarí', 'QAR', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Leu Rumano', 'RON', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dinar Serbio', 'RSD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Rublo Ruso', 'RUB', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Franco Ruandés', 'RWF', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Riyal Saudí', 'SAR', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar de las Islas Salomón', 'SBD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Rupia Seychelense', 'SCR', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Libra Sudanesa', 'SDG', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Corona Sueca', 'SEK', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar de Singapur', 'SGD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Libra de Santa Elena', 'SHP', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Leone', 'SLE', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Leone Antiguo', 'SLL', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Chelín Somalí', 'SOS', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar Surinamés', 'SRD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Libra Sursudanesa', 'SSP', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dobra', 'STN', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Libra Siria', 'SYP', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Lilangeni', 'SZL', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Baht', 'THB', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Somoni', 'TJS', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Manat Turcomano', 'TMT', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dinar Tunecino', 'TND', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Paʻanga', 'TOP', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Lira Turca', 'TRY', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar de Trinidad y Tobago', 'TTD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar de Tuvalu', 'TVD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Nuevo Dólar Taiwanés', 'TWD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Chelín Tanzano', 'TZS', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Grivna', 'UAH', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Chelín Ugandés', 'UGX', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Peso Uruguayo', 'UYU', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Som Uzbeko', 'UZS', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Bolívar Digital', 'VES', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dong', 'VND', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Vatu', 'VUV', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Tala', 'WST', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Franco CFA de África Central', 'XAF', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar del Caribe Oriental', 'XCD', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Derechos Especiales de Giro', 'XDR', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Franco CFA de África Occidental', 'XOF', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Franco CFP', 'XPF', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Rial Yemení', 'YER', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Rand', 'ZAR', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Kwacha Zambiano', 'ZMW', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda')),
('Dólar Zimbabuense', 'ZWL', (SELECT id FROM categoria_unidad_medida WHERE nombre = 'Moneda'));