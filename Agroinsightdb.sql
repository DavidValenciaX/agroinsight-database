...
CREATE TYPE estado_analisis_enum AS ENUM (
    'processing',
    'completed',
    'failed',
    'partial'
...
-- Crear enum para los niveles de severidad del log
...
CREATE TYPE nivel_labor_cultural_enum AS ENUM (
    'LOTE',
    'CULTIVO'
);
...
ALTER TABLE "cultivo" ADD FOREIGN KEY ("moneda_id") REFERENCES "unidad_medida" ("id");
...
CREATE TABLE "tipo_labor_cultural" (
  ...
  "nombre" VARCHAR(100) UNIQUE NOT NULL,
  "descripcion" TEXT,
  "nivel" nivel_labor_cultural_enum NOT NULL,
  "fecha_creacion" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT (CURRENT_TIMESTAMP AT TIME ZONE 'UTC'),
  "fecha_modificacion" TIMESTAMP WITH TIME ZONE DEFAULT (NULL)
);
...
CREATE TABLE "costo_mano_obra" (
  "id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "tarea_labor_id" INT NOT NULL UNIQUE,  -- Agregado UNIQUE para relación 1:1
...
ALTER TABLE "costo_mano_obra" ADD FOREIGN KEY ("tarea_labor_id") REFERENCES "tarea_labor_cultural" ("id");

ALTER TABLE "costo_mano_obra" ADD FOREIGN KEY ("moneda_id") REFERENCES "unidad_medida" ("id");

-- Crear tabla para categorías de insumos
CREATE TABLE "categoria_insumo_agricola" (
  "id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "nombre" VARCHAR(100) UNIQUE NOT NULL,
  "descripcion" TEXT,
  "fecha_creacion" TIMESTAMP WITH TIME ZONE DEFAULT (CURRENT_TIMESTAMP AT TIME ZONE 'UTC'),
...
-- Crear nueva tabla para insumos específicos
...
ALTER TABLE "insumo_agricola" ADD FOREIGN KEY ("categoria_id") REFERENCES "categoria_insumo_agricola" ("id");
ALTER TABLE "insumo_agricola" ADD FOREIGN KEY ("unidad_medida_id") REFERENCES "unidad_medida" ("id");

ALTER TABLE "insumo_agricola" ADD FOREIGN KEY ("moneda_id") REFERENCES "unidad_medida" ("id");
...
ALTER TABLE "maquinaria_agricola" ADD FOREIGN KEY ("tipo_maquinaria_id") REFERENCES "tipo_maquinaria_agricola" ("id");

ALTER TABLE "maquinaria_agricola" ADD FOREIGN KEY ("moneda_id") REFERENCES "unidad_medida" ("id");

CREATE TABLE "tarea_maquinaria" (
  "id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "tarea_labor_id" INT NOT NULL,
...
ALTER TABLE "tarea_maquinaria" ADD FOREIGN KEY ("tarea_labor_id") REFERENCES "tarea_labor_cultural" ("id");

ALTER TABLE "tarea_maquinaria" ADD FOREIGN KEY ("maquinaria_id") REFERENCES "maquinaria_agricola" ("id");
...
CREATE TABLE "registro_meteorologico" (
  ...
  "temperatura_sensacion" DECIMAL(4,2) NOT NULL,
  ...
  "nubosidad" DECIMAL(5,2) NOT NULL,
  "nubosidad_unidad_id" INT,
  "velocidad_viento" DECIMAL(5,2) NOT NULL,
  "velocidad_viento_unidad_id" INT,
  "direccion_viento" INT NOT NULL,
  "direccion_viento_unidad_id" INT,
  "rafaga_viento" DECIMAL(5,2),
  "rafaga_viento_unidad_id" INT,
  "visibilidad" INT,
  "visibilidad_unidad_id" INT,
  "punto_rocio" DECIMAL(4,2),
  "punto_rocio_unidad_id" INT,
  "descripcion_clima" VARCHAR(100),
  "codigo_clima" VARCHAR(10),
  "fecha_creacion" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT (CURRENT_TIMESTAMP AT TIME ZONE 'UTC'),
  "fecha_modificacion" TIMESTAMP WITH TIME ZONE DEFAULT (NULL)
);
...
ALTER TABLE "registro_meteorologico" ADD FOREIGN KEY ("nubosidad_unidad_id") REFERENCES "unidad_medida" ("id");
ALTER TABLE "registro_meteorologico" ADD FOREIGN KEY ("velocidad_viento_unidad_id") REFERENCES "unidad_medida" ("id");
ALTER TABLE "registro_meteorologico" ADD FOREIGN KEY ("direccion_viento_unidad_id") REFERENCES "unidad_medida" ("id");
ALTER TABLE "registro_meteorologico" ADD FOREIGN KEY ("rafaga_viento_unidad_id") REFERENCES "unidad_medida" ("id");
ALTER TABLE "registro_meteorologico" ADD FOREIGN KEY ("visibilidad_unidad_id") REFERENCES "unidad_medida" ("id");
ALTER TABLE "registro_meteorologico" ADD FOREIGN KEY ("punto_rocio_unidad_id") REFERENCES "unidad_medida" ("id");
...
CREATE TABLE "analisis_suelo" (
  ...
  "estado" estado_analisis_enum NOT NULL DEFAULT 'processing',
...
ALTER TABLE "analisis_suelo" ADD FOREIGN KEY ("tarea_labor_id") REFERENCES "tarea_labor_cultural" ("id");

CREATE TABLE "clasificacion_tipo_suelo" (
  "id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY NOT NULL,
  "analisis_suelo_id" INT NOT NULL,
  "imagen_url" VARCHAR(255) NOT NULL,
  "imagen_public_id" VARCHAR(255) NOT NULL,
  "resultado_analisis_id" INT NOT NULL,
  "confianza_clasificacion" DECIMAL(5,2) NOT NULL,
  "prob_alluvial_soil" DECIMAL(5,4) NOT NULL,
  "prob_black_soil" DECIMAL(5,4) NOT NULL,
  "prob_cinder_soil" DECIMAL(5,4) NOT NULL,
  "prob_clay_soil" DECIMAL(5,4) NOT NULL,
  "prob_laterite_soil" DECIMAL(5,4) NOT NULL,
  "prob_peat_soil" DECIMAL(5,4) NOT NULL,
  "prob_yellow_soil" DECIMAL(5,4) NOT NULL,
  "fecha_creacion" TIMESTAMP WITH TIME ZONE DEFAULT (CURRENT_TIMESTAMP AT TIME ZONE 'UTC'),
  "fecha_modificacion" TIMESTAMP WITH TIME ZONE DEFAULT (NULL)
);

ALTER TABLE "clasificacion_tipo_suelo" ADD FOREIGN KEY ("analisis_suelo_id") REFERENCES "analisis_suelo" ("id");
ALTER TABLE "clasificacion_tipo_suelo" ADD FOREIGN KEY ("resultado_analisis_id") REFERENCES "tipo_suelo" ("id");
...
-- Crear tabla para tipos de acciones
CREATE TABLE "tipo_accion_log" (
    "id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY NOT NULL,
    "nombre" VARCHAR(50) UNIQUE NOT NULL,
    "descripcion" TEXT,
    "fecha_creacion" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT (CURRENT_TIMESTAMP AT TIME ZONE 'UTC'),
...
CREATE TABLE "log_actividad" (
    ...
    "tipo_accion_nombre" VARCHAR(50) NOT NULL,
    "tabla_afectada" VARCHAR(100) NOT NULL,
    "endpoint" VARCHAR(200),
    "metodo_http" VARCHAR(10),
    "ip_address" VARCHAR(45),
    "user_agent" TEXT,
    "severidad" log_severity_enum NOT NULL DEFAULT 'INFO',
    "descripcion" TEXT,
    "registro_id" INT,
...
ALTER TABLE "log_actividad" ADD FOREIGN KEY ("usuario_id") REFERENCES "usuario" ("id");
ALTER TABLE "log_actividad" ADD FOREIGN KEY ("tipo_accion_id") REFERENCES "tipo_accion_log" ("id");
