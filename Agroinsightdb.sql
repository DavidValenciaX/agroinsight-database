...
CREATE TABLE "costo_mano_obra" (
  ...
  "fecha_modificacion" TIMESTAMP WITH TIME ZONE DEFAULT (NULL),
  FOREIGN KEY ("tarea_labor_id") REFERENCES "tarea_labor_cultural" ("id")
);
...
CREATE TABLE "insumo_agricola" (
  ...
  "fecha_creacion" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT (CURRENT_TIMESTAMP AT TIME ZONE 'UTC'),
  "fecha_modificacion" TIMESTAMP WITH TIME ZONE DEFAULT (NULL),
  FOREIGN KEY ("categoria_id") REFERENCES "categoria_insumo_agricola" ("id"),
...
CREATE TABLE "tarea_insumo" (
  ...
  "fecha_modificacion" TIMESTAMP WITH TIME ZONE DEFAULT (NULL),
  FOREIGN KEY ("tarea_labor_id") REFERENCES "tarea_labor_cultural" ("id"),
  FOREIGN KEY ("insumo_id") REFERENCES "insumo_agricola" ("id")
);
...
CREATE TABLE "maquinaria_agricola" (
  ...
  "fecha_creacion" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT (CURRENT_TIMESTAMP AT TIME ZONE 'UTC'),
  "fecha_modificacion" TIMESTAMP WITH TIME ZONE DEFAULT (NULL),
  FOREIGN KEY ("tipo_maquinaria_id") REFERENCES "tipo_maquinaria_agricola" ("id")
);
