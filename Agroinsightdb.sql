...
CREATE TABLE "grupo_deteccion_gusano_cogollero" (
  "id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY NOT NULL,
  "lote_id" INT NOT NULL,
  "fecha_deteccion" TIMESTAMP WITH TIME ZONE NOT NULL,
  "observaciones" TEXT,
  "fecha_creacion" TIMESTAMP WITH TIME ZONE DEFAULT (CURRENT_TIMESTAMP AT TIME ZONE 'UTC'),
  "fecha_modificacion" TIMESTAMP WITH TIME ZONE DEFAULT (NULL)
);

ALTER TABLE "grupo_deteccion_gusano_cogollero" ADD FOREIGN KEY ("lote_id") REFERENCES "lote" ("id");

CREATE TABLE "deteccion_gusano_cogollero" (
  "id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY NOT NULL,
  "grupo_deteccion_id" INT NOT NULL,
...
ALTER TABLE "deteccion_gusano_cogollero" ADD FOREIGN KEY ("grupo_deteccion_id") REFERENCES "grupo_deteccion_gusano_cogollero" ("id");
