...
CREATE TABLE "estado_usuario" (
  ...
  "descripcion" TEXT,
  "fecha_creacion" TIMESTAMP NOT NULL DEFAULT (CURRENT_TIMESTAMP AT TIME ZONE 'UTC'),
...
CREATE TABLE "blacklisted_tokens" (
  ...
  "usuario_id" INT NOT NULL,
  "blacklisted_at" TIMESTAMP DEFAULT (CURRENT_TIMESTAMP AT TIME ZONE 'UTC')
);
...
CREATE TABLE "alerta" (
  ...
  "fecha_generacion" TIMESTAMP NOT NULL DEFAULT (CURRENT_TIMESTAMP AT TIME ZONE 'UTC'),
...
CREATE TABLE "aplicacion_insumo" (
  ...
  "observaciones" TEXT,
  "fecha_creacion" TIMESTAMP DEFAULT (CURRENT_TIMESTAMP AT TIME ZONE 'UTC'),
  "fecha_modificacion" TIMESTAMP DEFAULT (NULL)
);
...
CREATE TABLE "deteccion_gusano_cogollero" (
  ...
  "observaciones" TEXT,
  "fecha_creacion" TIMESTAMP DEFAULT (CURRENT_TIMESTAMP AT TIME ZONE 'UTC'),
  "fecha_modificacion" TIMESTAMP DEFAULT (CURRENT_TIMESTAMP AT TIME ZONE 'UTC')
);
